...
{
	public class ChangeLoginTableViewCell : UITableViewCell
	{
		public UILabel CellText { get; set; }

		public ChangeLoginTableViewCell (string reuseIdentifier, float size) : base (UITableViewCellStyle.Default, reuseIdentifier)
		{
			CellText = new UILabel { 
				BackgroundColor = UIColor.Clear, 
                Font = UIFont.FromName ("HelveticaNeue", 15f),
				TextColor = UIColor.Clear.FromHexString(RSColors.RS_BLACK_3),
