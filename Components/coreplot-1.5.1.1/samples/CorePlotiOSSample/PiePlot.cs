...
using CoreGraphics = global::MonoTouch.CoreGraphics;
#endif
...
namespace CorePlotiOSSample
{
	public class PiePlot : PlotViewController
	{
		...
		void SetupPiePlots ()
		{
			...
			var color = new CPTColor (new CoreGraphics.CGColor (1f,1f,0f));
	...
	public class PieSourceData : CPTPieChartDataSource
	{
		...
		public override CPTFill GetSliceFill (CPTPieChart pieChart, nuint recordIndex)
		{
